...
def implementationNameLabels : List (String × String) := [
  ...
  ("guruswami-sudan-root-alekhnovich", "Alekhnovich root finding"),
  ("guruswami-sudan-root-alekhnovich-nttfast",
    "Alekhnovich root finding (fast mul/mod)"),
  ("guruswami-sudan-root-alekhnovich-fast",
    "Alekhnovich root finding (fast KoalaBear)"),
  ("guruswami-sudan-root-alekhnovich-fast-nttfast",
    "Alekhnovich root finding (fast mul/mod, fast KoalaBear)"),
