...
private def koalaBearBenchmarkFieldEnumeration :
...
private def fastKoalaBearBenchmarkFieldEnumeration :
...
private def runKoalaBearFiniteFieldRoots (preset : BenchPreset) (gen : StdGen) :
  ...
  let lvRow <- runTimed
    ...
    (fun _ ↦ lasVegasRootsWith CPolynomial.Raw.MulContext.naive
      ...
      koalaBearBenchmarkFieldEnumeration lvCfg lvProbes p)
    (checksumNormalizedRoots checksumKoalaBear) checksumIterations
  let lvNttRow <- runTimed
    ...
    (fun _ ↦ lasVegasRootsWith
      ...
      koalaBearFiniteFieldContext koalaBearBenchmarkFieldEnumeration lvCfg lvProbes p)
    (checksumNormalizedRoots checksumKoalaBear) checksumIterations
  ...
  let fastLvRow <- runTimed
    ...
    (fun _ ↦ lasVegasRootsWith CPolynomial.Raw.MulContext.naive
      ...
      fastKoalaBearBenchmarkFieldEnumeration lvCfg fastLvProbes fastP)
    (checksumNormalizedRoots checksumKoalaBearFast) checksumIterations
  let fastLvNttRow <- runTimed
    ...
    (fun _ ↦ lasVegasRootsWith
      ...
      fastKoalaBearFiniteFieldContext fastKoalaBearBenchmarkFieldEnumeration
