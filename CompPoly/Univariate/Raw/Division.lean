...
variable {R : Type*} [BEq R] [LawfulBEq R] [Ring R]
...
variable {R : Type*} [BEq R] [LawfulBEq R] [Field R]

omit [BEq R] in
/-- Multiplication by a constant commutes with `Polynomial.divByMonic` -/
lemma Polynomial.C_mul_divByMonic_eq (a : R) (p q : Polynomial R) (hq : q.Monic) :
...
private lemma not_monic_of_toPoly_zero [Field R] (q : CPolynomial.Raw R)
