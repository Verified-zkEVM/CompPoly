...
| `bench/evaluation-bench-*` | Generated, not source | Produced by `lake exe CompPolyBench`; keep reports as local or CI artifacts. |
...
- `bench/evaluation-bench-results-*.jsonl` and
  `bench/evaluation-bench-report-*.md` are generated benchmark outputs.
