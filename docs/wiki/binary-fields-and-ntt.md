...
(`irreducible_of_rabin_prime_power_of_card` at `8 = 2 ^ 3`), checking Frobenius remainders at
...
- [`../../CompPoly/Fields/Binary/BF64/Basic.lean`](../../CompPoly/Fields/Binary/BF64/Basic.lean)
  ...
  its cardinality. Degree 64 is composite, so `irreducible_of_rabin_prime_power_of_card` is used
  ...
  `_of_card` form is the one to call.
